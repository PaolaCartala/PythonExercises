...
class Printers:
    ...
    @staticmethod
    def print_sortgroup_submenu() -> None:
        """Submenu Sort or Group by:"""
        logging.info("1) Sort tasks by ascending order\
                    \n2) Sort tasks by descending order\
                    \n3) Group tasks by tags\n")
    ...
    @staticmethod
    def print_critical():
        logging.critical('CRITICAL: Please intitialize the database')
